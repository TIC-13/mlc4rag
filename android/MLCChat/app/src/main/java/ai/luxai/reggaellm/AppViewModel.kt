...
class AppViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private var text_searcher = TextSearcherClient.create(application.applicationContext)
    ...
    inner class ChatState {
        ...
        fun requestGenerate(prompt: String) {
            ...
            val results = text_searcher.search(prompt)
            var inp = prompt
            ...
            appendMessage(MessageRole.User, inp)
